Feature: Registration & email confirmation
  ...
  Scenario: a new player signs up, gets the email, and confirms onto the map
    Given I open the landing page
    When I click "count me in"
    And I register as "Test Player" with email "confirm@example.com" password "hunter2pass" in ZIP "78701"
